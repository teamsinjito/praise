...
class PraiseController extends Controller
{
    ...
    public function praiseCreate(User $auth_user,PraiseCreate $request)
    {
        ...
        try{
            ...
            //ユーザアイコンを整形
            $from_user_img= CraftImageController::trimUserIconCircle(Image::make(public_path('img/user_icon_default.png')));
            $to_user_img= CraftImageController::trimUserIconCircle(Image::make(public_path('img/user_icon_default.png')));
    
            //スタンプを整形
            $stamp_img=CraftImageController::trimStampIcon(Image::make(public_path('img/stamp_icon_default.png')));
            ...
            //矢印を整形
            $arrow_img = CraftImageController::trimArrowIcon(Image::make(public_path('img/arrow.png')));
            ...
            $board_img->save(public_path('img/'.$board->id.'_1.png'));
            $board_img_message->save(public_path('img/'.$board->id.'_2.png'));
