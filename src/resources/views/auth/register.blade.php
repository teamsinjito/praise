                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4 offset-3 image-area">
                                <img class="my-icon border" src="{{ asset('img/user_icon_default.png') }}?<?php echo date("YmdHis");?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="profile" rows="4" cols="40" type="text" class="form-control @error('profile') is-invalid @enderror" name="profile" value="{{ old('profile') }}"  autocomplete="profile">
                                </textarea>
                                @error('profile')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-sm-6 offset-sm-4 offset-2">
